...
public class HasiniCPT {
    ...
    {
        main1 = con.loadImage("main1.png");
        main2 = con.loadImage("main2.png");
        imgHelpButton = con.loadImage("helpButton.png");
        play = con.loadImage("play.png");
        quit = con.loadImage("quit.png");
        ...
        high = con.loadImage("high.png");
        moneyBonus = con.loadImage("bonusmoney.png");
		...
		miniStoryBoard = con.loadImage("miniStoryBoard.png");
		val_pix = con.loadImage("pix_val.png");
		nico_pix = con.loadImage("pix_nico.png");
		nico_pix_1 = con.loadImage("pix_nico_1.png");
		val0 = con.loadImage("page0.png");
		val1 = con.loadImage("page1.png");
		val2 = con.loadImage("page2.png");
		val3 = con.loadImage("page3.png");
		val4 = con.loadImage("page4.png");
		val5 = con.loadImage("page5.png");
		val6 = con.loadImage("page6.png");
		nico7 = con.loadImage("page7.png");
		nico8 = con.loadImage("page8.png");
		nico9 = con.loadImage("page9.png");
		nico10 = con.loadImage("page10.png");
		nico11 = con.loadImage("page11.png");
		val12 = con.loadImage("page12.png");
		nico13 = con.loadImage("page13.png");
		nico14 = con.loadImage("page14.png");
		nico15 = con.loadImage("page15.png");
		val16 = con.loadImage("page16.png");
		instructionboard = con.loadImage("instructionsboard.png");
    }
	...
	public static void playBackStoryPart1(Console con) {
		...
		con.sleep(2000);
		drawStoryBoardPage(con, val14);
		con.sleep(2000);
		drawStoryBoardPage(con, val15);
		con.sleep(2000);
